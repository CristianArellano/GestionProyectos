...
<link href="../Style/Style_RegistrarDatosU/StyleregistrarDatosGestion.css" rel="stylesheet" >
 ...
 <div class="contenido">
       ...
       <div class="encabezado_contenido">
           ...
           <img src="../z_recursos/img/logo-minsa.png" alt="" class="logo_minsa">
           <h1 class="title">REGISTRO de usuario</h1>
       </div>
       

 <form action="Registrar-Login.php" method="POST" class="form_credenciales">
