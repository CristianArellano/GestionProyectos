...
<link href="../Style/Style_RegistrarDatosU/StyleRegistrarDatoC.css" rel="stylesheet" >
...
<style>.contenido {
        ...
        text-align: center;  
        z-index: 3;
          background: url("../z_recursos/img/paciente_nuevo.png");
...
<img src="../z_recursos/img/minsa.png" style="margin-top:20px;margin-left:130%;height:100px;">
    <h1 class="title" style="margin-top:30px; margin-top:60px ;color:white;">REGISTRO PACIENTE</h1>
</div>

   


<form style="height:100%;margin-left:50%; margin-top:-170px; " action="RegistrarDatos_Gestion_C.php" method="POST" >
...
<!-- CSS only -->
				  ...
				  <div class="form-group col-md-35">
					<label for="inputPassword4">Nombres Completo</label>
					<input type="text" name="nombre" class="form-control" id="inputPassword4" placeholder="">
				  </div>
				
				<div class="form-group col-md-25">
				  <label for="inputAddress ">Apellidos Paternos</label>
				  <input type="text" name="apellidoPaterno" class="form-control" id="inputAddress" placeholder="">
				</div>
				<div class="form-group col-md-25">
				  <label for="inputAddress2">Apellidos Maternos</label>
				  <input type="text" name="apellidoMaterno" class="form-control" id="inputAddress2" placeholder="">
				</div>

				
				  <div class="form-group col-md-25"  >
					<label for="inputCity">Edad</label>
					<input type="number" name="edad" class="form-control" id="inputCity">
				  </div>

                 
				  <div class="form-group col-md-25"  >
					<label for="inputCity">Celular</label>
					<input type="number" name="numero" class="form-control" id="inputCity">
				  </div>
