...
try{
    ...
    $consulta="INSERT INTO loginusuarios(`USUARIO`,`PASSWORD`,`DNI`) VALUES (:user,:contra,:dni)";
    ...
    if($comprobar==0){
       ...
       <script>
        $mensaje="Registro exitoso. ¿Desea continuar agregando usuarios?";
         if(confirm($mensaje)){
         window.location='http://localhost/GESTION_PROYECTO_WEB/RegistrarDatosU/registrar-datos_c.php';
         }else{
