          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.1s">
                <h4 style="color:rgb(78, 75, 75);" class="h-light">Brindando <span class="color">atención segura</span> y de calidad</h4>
              </div>
                    ...
                    <div class="panel-body">
                      ...
                      <?php foreach ($res as $usuarios):?>  
                       ...
                       <div class="row">
                        ...
                        <p class="lead-footer">* Recuerda la atención es respecto a la llegada del paciente</p>
          ...
          <div class="col-sm-3 col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <p>
                  El dia de tu atención dependera si se encuentran cupos disponibles con la especialidad que requiera.
                </p>
              </div>
            </div>
          </div>
