...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
  ...
  <div id="wrapper">
    ...
    <nav style="height:10%;" class="navbar navbar-custom navbar-fixed-top" role="navigation">
     <!-- <div class="top-area">
        <div class="container">
          <div class="row">
      ...
      <div class="container navigation">
        ...
        <div class="navbar-header page-scroll">
          ...
          <a style="margin-top:-7px;" class="navbar-brand" href="index.html">
                    <img src="img/logo2.png" alt="" width="150" height="60" />
                </a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
          <ul class="nav navbar-nav">
            <li style="top:15px"class="active"><a href="#intro">Inicio</a></li>
            <li style="top:15px"><a href="">Servicios</a></li>
            <li style="top:15px"><a href="">Especialistas</a></li>
            <li style="top:15px"><a href="">Facilidades</a></li>
            <li style="top:15px"><a href="http://localhost/Cliente/citas.php">Gestiones</a></li>
...
<style>.navbar-nav li{margin-top:-15px;}</style>
             
            <li style="top:15px;"><a href="./Login_C/loginindex.php">INICIAR SESIÓN</a></li>
           <?php } else{?>
            <li style="top:-5px; margin:0px !important;" class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a style="color:black !important;" href="./Login_C/cerrarsesion.php" name="salir-session">Cerrar Sesión</a></li>
              </ul>
            </li>
            <?php }?>
  ...
  <main class="hero">
    <div class="promo">
      <h1>Bienvenido al portal de <b>Samay</b></h1>
      <p>Reserva tus citas, conoce a tus doctores!</p>
      <button type="button">Pedir una Cita</button>
    </div>
              ...
              <div class="wow fadeInRight" data-wow-delay="0.1s">
                <div class="text-right">
                  <div class="credits">
                    ...
                    <a href="http://www.servitecflhuaraz.com/">ProOnliPc Education Templates</a> by ProOnliPc
                  </div>
                </div>
              </div>
            </div>
